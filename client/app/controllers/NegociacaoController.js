System.register(['../domain/index.js', '../ui/index.js', '../util/index.js'], function (_export, _context) {
    ...
    var Negociacoes, NegociacaoService, Negociacao, NegociacoesView, MessageView, Mensagem, DateConverter, getNegociacaoDao, Bind, getExceptionMessage, debounce;
        ...
        execute: function () {
            class NegociacaoController {
                ...
                importaNegociacaoes() {
                    ...
                    return _asyncToGenerator(function* () {
                        try {
                            const negociacoes = yield _this2._service.obtemNegociacoesDoPeriodo();
                            ...
                            _this2._mensagem.texto = 'Negociações do período importadas com sucesso';
                        } catch (err) {
